      ...
      <div class="row justify-content-center">
        ...
        <div class="row">
         ...
         <div class="col-sm-4">
          ...
          <div class="col-sm-4">
              <input type='button' value='voir la database' id='voir_database()'>
          </div>
          
          <div class="col-sm-4">
             <input type='button' value='remplir la database' id='remplir_database()'>
          </div>
          <br><br>
          <div class="col-sm-12">
             <input type='button' value='voir la prédiction' id='voir_prédiction()'>
          </div>
