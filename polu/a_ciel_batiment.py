...
class expé:
    ...
    def contraste(self):
        ...
        #enelvee les roi
        lumi_fond = cv2.imread("coucou.png")
...
#yo.image_gris()
#yo.contraste()
#bon ben enfete ca servait a rien de faire le truk otsu jcrois
