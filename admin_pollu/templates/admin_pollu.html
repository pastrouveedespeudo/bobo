...
<body id="page-top">
  ...
  <section class="page-section bg-primary" id="about">
        ...
        <div class="row">
         ...
         <div class="col-sm-4">
            <form method='POST' action='construction'>{% csrf_token %}
              <input type='button' value='Construire la database' id='construction'>
            </form>
         </div>
              
          <div class="col-sm-4">
              <input type='button' value='voir la database' onclick='voir_database()'>
          </div>
          
          <div class="col-sm-4">
             <input type='button' value='remplir la database' onclick='remplir_database()'>
          </div>
          <br><br>
          <div class="col-sm-12">
             <input type='button' value='voir la prédiction' onclick='voir_prédiction()'>
          </div>
    ...
    <script>
        ...
        function voir_database(){
            document.location.href="/admin_pollu/database"; 
            }
        function remplir_database(){
            document.location.href="/admin_pollu/remplir_database"; 
            }
        function voir_prédiction(){
            document.location.href="/admin_pollu/prédiction"; 
            }
    ...
    jQuery("#construction").on("click", function(e){
            jQuery.ajax({
                data:{
