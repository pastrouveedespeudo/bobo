...
<body id="page-top">
  ...
  <section class="page-section bg-primary" id="about">
    <div class="container">
      ...
      <center><div id='messagefin'></div></center>
      ...
      <div class="row justify-content-center">
        ...
        <center><div id='message'>Afin de remplir une database, nous devons le faire sur une plage horraire d'une
        minute. En effet, nous interrogeons la database via l'heure à la minute prés. Perso je comprendrai rien a ce
        msg alors travaille le</div></center>
        <br><br>
        <div class="row">
        
         <div class="col-sm-12">
            <form method='POST' action='construction'>{% csrf_token %}
              <input type='button' value='remplir la database' id='remplir'>
            </form>
         </div>
        <br><br>

        <div class="col-sm-12">
          <form method='POST' action='remplir_database'>{% csrf_token %}
          <center><input type='button' value='verification' id='verification' style='display:none;'></center>
          </form>
        </div><br><br>


        <div class="col-sm-12" style='display:none;' id='divdelete'>
        <p><i>A noter que nous effacerons automatique les données invalides</i></p>
        </div>
    ...
    jQuery("#verification").on("click", function(e){
            jQuery.ajax({
                data:{
                ...
                type:"POST",
                url:"/admin_pollu/remplir_database"
            })
            .done(function(data){
                if (data.error){
    ...
    jQuery("#remplir").on("click", function(e){
            jQuery.ajax({
                data:{
                    'csrfmiddlewaretoken': '{{csrf_token}}' , 
